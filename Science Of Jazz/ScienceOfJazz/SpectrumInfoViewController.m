...
@interface SpectrumInfoViewController ()

@end

@implementation SpectrumInfoViewController
@synthesize infoView;
...
-(void) viewWillAppear:(BOOL)animated {
    ...
    NSURL *infoURL = [NSURL URLWithString:@"http://jazz.ece.drexel.edu/ScienceOfJazz/Info/spectrum.html"];
...
-(void) connection:(NSURLConnection *)connection didFailWithError:(NSError *)error {
    ...
    NSString* path = [[NSBundle mainBundle] pathForResource:@"spectrumError" 
                                                     ofType:@"html"];
